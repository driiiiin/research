        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-3">
                    ...
                    <!-- Carousel Section -->
                    <div class="max-w-4xl mx-auto mb-8" x-data="{ active: 0, images: ['/images/dohelib1.png', '/images/dohelib2.png', '/images/dohelib3.png'] }" x-init="setInterval(() => { active = active === images.length - 1 ? 0 : active + 1 }, 3000)">
                        <div class="relative overflow-hidden rounded-2xl shadow-lg">
                            <div class="flex transition-transform duration-500 ease-in-out" :style="'transform: translateX(-' + (active * 100) + '%)'">
                                <template x-for="(img, idx) in images" :key="img">
                                    <img :src="img" class="w-full h-64 object-cover flex-shrink-0" />
                                </template>
                            </div>
                            <!-- Prev Button -->
