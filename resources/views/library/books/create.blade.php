                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="isbn" name="isbn" type="text" class="mt-1 block w-full"
                                        value="{{ old('isbn') }}" placeholder="e.g., 978-0-123456-47-2" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="edition" name="edition" type="text" class="mt-1 block w-full"
                                        value="{{ old('edition') }}" placeholder="e.g., 1st Edition" />
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="genre" name="genre" type="text" class="mt-1 block w-full"
                                        value="{{ old('genre') }}" placeholder="e.g., Fiction, Science, History" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="price" name="price" type="number" step="0.01" class="mt-1 block w-full"
                                        value="{{ old('price') }}" min="0" placeholder="0.00" />
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="location" name="location" type="text" class="mt-1 block w-full"
                                        value="{{ old('location') }}" placeholder="e.g., Shelf A, Row 3" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="call_number" name="call_number" type="text" class="mt-1 block w-full"
                                        value="{{ old('call_number') }}" placeholder="e.g., FIC ROW" />
