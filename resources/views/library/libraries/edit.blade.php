                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <x-text-input id="name" name="name" type="text" class="mt-1 block w-full"
                                    value="{{ old('name', $library->name) }}" placeholder="e.g., National Library, City Library" required />
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description" rows="3"
                                    ...
                                    placeholder="Brief description of this library...">{{ old('description', $library->description) }}</textarea>
                                <x-input-error :messages="$errors->get('description')" class="mt-2" />
                            </div>
                            <div>
                                <x-input-label for="location" value="Location" />
                                <x-text-input id="location" name="location" type="text" class="mt-1 block w-full"
                                    value="{{ old('location', $library->location) }}" placeholder="e.g., Manila, Cebu City, Davao" />
