        ...
        <div class="max-w-5xl mx-auto px-4">
            <style>
                ...
                @media print {
                    ...
                    #health-research-details, #health-research-details * { visibility: visible; }
                    #health-research-details {
                        position: absolute; left: 0; top: 0; width: 100%; background: white !important; box-shadow: none !important; padding: 20px !important;
                    }
                    .section-header { background: #14532d !important; color: white !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
                    .form-card { break-inside: avoid; page-break-inside: avoid; }
            ...
            <div id="health-research-details" class="bg-white rounded-3xl shadow-2xl px-8 pb-8 space-y-6">
                <div class="relative mb-6 pt-6">
                    ...
                    <div class="no-print absolute top-6 right-0 flex items-center space-x-2">
                        ...
                        <a href="{{ route('welcome') }}" class="text-gray-600 hover:text-gray-800 transition-colors duration-200 p-2 rounded-lg hover:bg-gray-100">
            ...
            <div>
                ...
                <div class="w-full flex justify-center mb-4 mt-1">
                    <span class="section-header inline-flex items-center justify-center w-full px-4 py-2 rounded-lg">
                        <h3 class="text-lg font-bold text-white tracking-wide text-center w-full flex items-center justify-center gap-2">Focus Area</h3>
                    </span>
                </div>
                <div class="form-card rounded-2xl p-6">
                ...
                <div class="w-full flex justify-center mb-4 mt-1">
                    <span class="section-header inline-flex items-center justify-center w-full px-4 py-2 rounded-lg">
                        <h3 class="text-lg font-bold text-white tracking-wide text-center w-full flex items-center justify-center gap-2">National Unified Health Research Agenda of the Philippines</h3>
                    </span>
                </div>
                <div class="form-card rounded-2xl p-6">
                ...
                <div class="w-full flex justify-center mb-4 mt-1">
                    <span class="section-header inline-flex items-center justify-center w-full px-4 py-2 rounded-lg">
                        <h3 class="text-lg font-bold text-white tracking-wide text-center w-full flex items-center justify-center gap-2">Medium-Term Health Research and Innovation Agenda (MTHRIA)</h3>
                    </span>
                </div>
                <div class="form-card rounded-2xl p-6">
