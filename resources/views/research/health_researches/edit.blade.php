<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('research.health_researches.show', $book) }}" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-md text-sm font-medium">
                Back to Book
            </a>
        </div>
    </x-slot>
    ...
    <div>
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('research.health_researches.update', $book) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="flex items-center justify-end space-x-4">
                            <a href="{{ route('research.health_researches.show', $book) }}"
