<div class="mx-auto py-6 px-4 sm:px-6 lg:px-8 flex items-start">
    ...
    <div class="flex items-center" style="margin-left: 0.5rem;">
        ...
        <div class="flex flex-col justify-center" style="height: 60px;">
            ...
            <span class="font-black uppercase tracking-widest" style="letter-spacing: 4px; color: #14532d; font-size: 2.5rem; line-height: 1; text-shadow: 3px 3px 10px rgba(20,83,45,0.35), 0 4px 12px rgba(0,0,0,0.25);">
